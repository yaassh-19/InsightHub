...
const PublishForm = () =>{
    ...
    let {blog, blog : {title, tags, des, banner, content},setEditorState, setBlog} = useContext(EditorContext);
    ...
    const publishBlog = (e) => {
        ...
        if (!des.length || des.length > characterLimit){
            return toast.error(`Write a description of your blog within ${characterLimit} characters to publish`)
        }
            ...
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <textarea 
                        ...
                        onChange={handleBlogDesChange} onKeyDown={handleTitleKeyDown}
                        >
