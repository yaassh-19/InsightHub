...
const BlogEditor = () =>{
    ...
    const handlePublishEvent = () => {
        ...
        if (!title.length){
            return toast.error("Enter the Title to publish it")
        }
        if (textEditor.isReady){
            ...
            <AnimationWrapper>
                <section>
                    <div className="mx-auto max-w-[900px] w-full">
                        <div className="relative aspect-video hover:opacity-100 bg-white border-4 border-grey">
                        ...
                        <textarea
                            ...
                            placeholder-opacity-40" onKeyDown={handleTitleKeyDown} onChange={handleTitleChange}>
